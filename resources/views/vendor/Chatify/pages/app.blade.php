        ...
        <div class="m-header">
            ...
            <div class="messenger-listView-tabs">
                <a href="#" @if($type == 'user') class="active-tab" @endif data-view="users">
                    <span class="far fa-user"></span> Personne</a>
        ...
        <div class="m-body contacts-container">
           ...
           <div class="messenger-tab search-tab app-scroll"app-scroll" data-view="search">
                ...
                <div class="search-records">
                    <p class="message-hint center-el"><span>rechercher..</span></p>
                </div>
             </div>
        </div>
    </div>
        ...
        <div class="m-header m-header-messaging">
            <nav>
                ...
                <nav class="m-header-right">
                    ...
                    @if(Auth::user()->type=="App\Models\Etudiant")
                    <a href="/profs/{{Auth::user()->id}}"><i class="fas fa-home"></i></a>
                    @else
                    <a href="{{route('listSub.index')}}"><i class="fas fa-home"></i></a>   
                    @endif
