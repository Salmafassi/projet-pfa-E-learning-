...
$(document).ready(function(){
  ...
  <div class="wrapper1">
   ...
   <div class="profile-card__cnt js-profile-cnt">
    <div style="display:none" id="div2">
      <form method="POST" action="{{ Route('updateProfileProf') }}" enctype="multipart/form-data"  > 
        @csrf
        @method('PUT')
  ...
  <div id="erreuremail" style="color:red;margin-bottom:8px;display:none;"> Email invalide</div>
...
<div id="erreurphone" style="color:red;margin-bottom:8px;display:none">numéro téléphone invalide</div>
<div class="form-group d-flex col-md-10 ml-auto mr-auto">
  <label for="" style="margin-top:5px">Specialité:  </label>
  <input type="text" id="specialite" name="specialite"  style="margin-left:30px;" class="form-control"  placeholder="enter your Speciality" value="{{Auth::user()->spécialité}}"
     required autofocus />
...
<div class="collapse" id="contenu">
  ...
  <input type="password" id="password" name="password"   style="margin-left:15px;" class="form-control"  placeholder="Enter your new password " 
 />
  
</div>
<div id="erreurpass" style="color:red;margin-bottom:8px;display:none">password doit contenir 8 caractères</div>
<div class="form-group d-flex col-md-10 ml-auto mr-auto">
 
  
  <input type="password" id="password_confirmation" name="password_confirmation"  style="margin-left:15px;" class="form-control"  placeholder="confirm your password " 
  />
  <input type="hidden" id="hide"   style="margin-left:15px;" class="form-control"   value="1"
  />
</div>
<div id="erreurpassconfi" style="color:red;margin-bottom:8px;display:none">les deux passwords ne sont pas semblables</div>
</div>
<br><br>
<button  type="submit"  class="btn" style="border-radius: 20px; 
    ...
    <div style="display:block" id="div1">
        ...
        <div class="profile-card__txt" ><strong style="margin-right:50px">Téléphone: </strong><span >{{Auth::user()->telephone}}</span></div>
        <div class="profile-card__txt" ><strong style="margin-right:50px">Specialité: </strong><span >{{Auth::user()->spécialité}}</span></div>
